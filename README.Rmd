...
@rasmont2019 propose un jeu de données du recensement des abeilles sauvages belges de 1810 à 2018.
...
Ce projet est individuel et libre. Il vous permettra de démontrer que vous avez acquis les compétences suivantes :
...
Ce projet est associé au template suivant : <https://github.com/BioDataScience-Course/C06Ia_map>
